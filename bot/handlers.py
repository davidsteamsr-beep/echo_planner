...
START_TEXT = (
    ...
    "Вместо заполнения таблиц, форм или выбора категорий бот определяет тип записи, "
    "извлекает ключевые данные (сумму, дату, время, название) и сохраняет их в соответствующий раздел.\n\n"
    "Разделы:\n"
...
def start_kb() -> InlineKeyboardMarkup:
    ...
    if WEBAPP_URL:
        ...
        row.append(InlineKeyboardButton(text="PLANNER 🏳️", callback_data="open_app"))
...
async def cmd_tariffs(message: Message):
    ...
    if photo.exists():
        ...
        await message.answer(TARIFFS_TEXT, reply_markup=tariffs_kb())
...
async def cb_tariffs(call: CallbackQuery):
    ...
    if photo.exists():
        ...
        await call.message.answer(TARIFFS_TEXT, reply_markup=tariffs_kb())
